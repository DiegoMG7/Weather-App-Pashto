...
class _TodayState extends State<Today> {
  ...
  Widget weatherData() => DataTable(
      columns: [
        DataColumn(label: Text('اندازه کول',style: Styles.header2)),
        DataColumn(label: Text('',style: Styles.header2)),
        DataColumn(label: Text('لوستل',style: Styles.header2)),
      ],
      rows: [
        DataRow(cells:[
          DataCell(Text('د لوستلو وخت',style: Styles.textDefault)),
          DataCell(Icon(Icons.access_time, size: 36, color: Colors.black)),
          DataCell(Text('${hourConverter(tzData)}',style: Styles.textDefault)),

        ]),
        DataRow(cells:[
          DataCell(Text('اوسنی تودوخه',style: Styles.textDefault)),
        ...
        DataRow(cells:[
          DataCell(Text('د تودوخی لوړه درجه',style: Styles.textDefault)),
        ...
        DataRow(cells:[
          DataCell(Text('د تودوخی ټیټه درجه',style: Styles.textDefault)),
        ...
        DataRow(cells:[
          DataCell(Text('د باد لوری',style: Styles.textDefault)),
        ...
        DataRow(cells:[
          DataCell(Text('د باد سرعت',style: Styles.textDefault)),
        ...
        DataRow(cells:[
          DataCell(Text('باران',style: Styles.textDefault)),
        ...
        DataRow(cells:[
          DataCell(Text('لمر ختل',style: Styles.textDefault)),
        ...
        DataRow(cells:[
          DataCell(Text('لمر لویدل',style: Styles.textDefault)),
