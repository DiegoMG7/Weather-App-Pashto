...
class _StartState extends State<Start> {
  String dropdownValue = 'یوه گزینه انتخاب کړئ';
  ...
  void getData(String valueWS) async {
    ...
    if(valueWS == 'کندهار- محمد اکرم'){
      macValue = '84:F3:EB:54:51:76';
      lat = '31.62887';
      lon = '65.73717';
      timeZ = 'Asia/Kabul';
      //Kandahar, Mohammad Akram
    }
    else if(valueWS == 'پنجشیر- بیگ محمدخیل'){
      macValue = '84:F3:EB:54:50:54';
      lat = '35.50257';
      lon = '69.95503';
      timeZ = 'Asia/Kabul';
      //Panjshir, Big Mohammad Khil
    }
    ...
    else if(valueWS == 'بدخشان- قرغ اول'){
      macValue = 'A4:CF:12:A0:2D:77';
      lat = '36.73477';
      lon = '70.81199';
      timeZ = 'Asia/Kabul';
      //Badakhshan, Qaragh Awal
    }
      ...
      lon = '70.35111';
      timeZ = 'Asia/Kabul';
      //03 Badakhshan, Sare Kotal
    }
    else if(valueWS == 'بدخشان - نو آباد پنگاني'){
      macValue = 'A4:CF:12:A0:2D:F3';
      lat = '37.00099';
      lon = '70.27300';
      timeZ = 'Asia/Kabul';
      //02 Badakhshan, Naw Abad Pingani
    }
    ...
    try {
      if(weatherData[0] == null)
        Toast.show("دستگاه راپور نورکوی", context, duration: Toast.LENGTH_LONG, gravity:  Toast.BOTTOM);
      else{
            ...
            body: SafeArea(
              child: Column(
                children: <Widget>[
                  ...
                  Padding(
                    padding: const EdgeInsets.fromLTRB(0.0,50.0,80.0,10.0),
                    child: Text(                                                                   //name of the App
                      'خپله ټولنه غوره کړئ',
                      style:TextStyle(
                        fontFamily: 'SourceSansPro-SemiBold',
                  ...
                  Container(
                      ...
                      child: DropdownButton<String>(
                        ...
                        iconSize: 35,
                        elevation: 16,
                        style: TextStyle(color: Colors.black, fontSize: 20, fontFamily: 'SourceSansPro-SemiBold'),
                        ...
                        items: <String>['یوه گزینه انتخاب کړئ','کندهار- محمد اکرم', 'پنجشیر- بیگ محمدخیل', 'Kabul, World Bank','بدخشان- قرغ اول','بدخشان - سرکوتل','بدخشان - نو آباد پنگاني','Chapel Hill, USA']
